...
public class KeyInterpolator {
     ...
     *
     * @param ord   Порядковое значение первичного ключа.
     * @param count Номер записи.
     */
     ...
     *
     * @param count The ordinal number of record.
     */
