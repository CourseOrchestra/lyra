...
If you add `FormInstantiationParameters` argument to the form's constructor,
the respective object will be passed to the constructor automatically. You may also define
`FormInstantiationParameters` field annotated with `@FormParams` annotation, and its value will be automatically injected.
